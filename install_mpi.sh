...
echo "export PATH='$PATH:/software/openmpi/3.1.2/bin'" >> /users/sa834534/.bashrc
echo "export LD_LIBRARY_PATH='$LD_LIBRARY_PATH:/software/openmpi/3.1.2/lib/'" >> /users/sa834534/.bashrc
cd ..
